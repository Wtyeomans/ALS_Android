...
public class HistoryFragment extends Fragment{
    ...
    private double armLvalue, armRvalue, legLvalue, legRvalue;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        //Creating Arm/Leg Test Results Display
        ...
        TextView lLvalue = (TextView) view.findViewById(R.id.legLtxt);
        lLvalue.setText(String.valueOf(Context.lLegResults.armRotation));
        TextView lRvalue = (TextView) view.findViewById(R.id.legRtxt);
        lRvalue.setText(String.valueOf(Context.rLegResults.armRotation));
        ...
        initArmGraph(armGraph, armLvalue, armRvalue, legLvalue, legRvalue);
    ...
    public void setArmValues(){
        ...
        legRvalue = (Context.rLegResults.armRotation);
        legLvalue = (Context.lLegResults.armRotation);
    ...
    public void initArmGraph(GraphView graph, double armLvalue, double armRvalue, double legLvalue, double legRvalue){
        ...
        BarGraphSeries<DataPoint> series2 = new BarGraphSeries<>(new DataPoint[] {
                new DataPoint(0, 0),
                new DataPoint(1, 0),
                new DataPoint(2, armRvalue),
                new DataPoint(3, legRvalue),
                new DataPoint(4, 0)
        });
    ...
    public double getArmLvalue(){
        return armLvalue;
    }

    public double getArmRvalue(){
        return armRvalue;
    }

    public double getLegLvalue(){
        return legLvalue;
    }

    public double getLegRvalue(){
        return legRvalue;
    }

    public int[] getToeTapValues(){
        int[] results = {tvalue10, tvalue20, tvalue30, tvaluetotal};
        return results;
    }

    public int[] getRightFingerValues(){
        int[] results = {rvalue10, rvalue20, rvalue30, rvaluetotal};
        return results;
    }

    public int[] getLeftFingerValues(){
        int[] results = {lvalue10, lvalue20, lvalue30, lvaluetotal};
        return results;
    }
}