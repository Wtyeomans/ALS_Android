...
public class GyroscopeActivity extends Activity {
    ...
    public void returnFromRotationTest(View view) {
        ...
        rotation[0] = String.valueOf(Math.abs(Float.valueOf(degreeButton.getText().toString())));
        ...
        rotation[1] = appendages[appendage];
        rotation[2] = sides[side];

        String UID = myDb.getUID();
        boolean inserted = myDb.insertArmRotationData(UID, appendages[appendage], sides[side], Float.valueOf(rotation[0]), currentDate);
